export type TransactionType = 'expense' | 'income' | 'borrow'
export type BorrowDirection = 'lent' | 'borrowed'
...
export interface Transaction {
   ...
   *  'lent'     - someone borrowed money from me
   *  'borrowed' - I borrowed money from someone else
   */
   ...
   *  'add'    - money added to the account
   *  'deduct' - money taken from the account
...
export const BORROW_CATEGORIES: Category[] = [
  { id: 'lent', label: 'Lent', emoji: '🤝', color: '#F59E0B' },
  { id: 'borrowed', label: 'Borrowed', emoji: '🧾', color: '#38BDF8' },
]
